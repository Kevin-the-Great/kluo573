...
# ================= 3. 自动匹配模型权重 =================
case "$TASK_SUITE" in
    "libero_spatial") MODEL_DIR="LIBERO-Spatial-Pro" ;;
    "libero_object")  MODEL_DIR="LIBERO-Object-Pro" ;;
    "libero_goal")    MODEL_DIR="LIBERO-Goal-Pro" ;;
    "libero_10")      MODEL_DIR="LIBERO-Long-Pro" ;;
